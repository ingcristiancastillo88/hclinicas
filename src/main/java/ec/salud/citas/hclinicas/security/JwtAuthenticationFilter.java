...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            final String correo = jwtService.extraerUsername(jwt);

            // Solo procesar si hay usuario y aún no está autenticado en el contexto
            ...
            // No lanzamos excepción: Spring Security devolverá 401 automáticamente
        }
